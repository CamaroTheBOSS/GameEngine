...
set CompilerFlags= -Od -nologo -GR- -MTd -Oi -W4 -WX -wd4100 -wd4189 -wd4505 -wd4005 -Zi -Fm -std:c++20
set CompilerFlags= -DPROFILER -DINTERNAL_BUILD %CompilerFlags%
...
pushd ..\build
  ...
  cl %CompilerFlags% -DTRANSLATION_UNIT=0 ..\code\engine.cpp -LD engine_optimized.obj /link -incremental:no -opt:ref -PDB:engine%random%.pdb -EXPORT:GameMainLoopFrame -EXPORT:GameFillSoundBuffer -EXPORT:DebugInit -EXPORT:DebugFinishFrame
