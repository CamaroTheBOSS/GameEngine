...
pushd ..\build
  ...
  cl %CompilerFlags% -DTRANSLATION_UNIT=0 ..\code\engine.cpp -LD engine_optimized.obj /link -incremental:no -opt:ref -PDB:engine%random%.pdb -EXPORT:GameMainLoopFrame -EXPORT:GameFillSoundBuffer -EXPORT:DebugInit
